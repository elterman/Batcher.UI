...
const Icon = ({ style = {}, color = `${WHITE}`, width = 160, viewBox = '0 0 100 100' }) => {
  return (
    <svg className="spinner" style={{ ...style }} width={width} height={width} viewBox={viewBox} xmlns="http://www.w3.org/2000/svg">
